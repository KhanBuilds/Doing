...
void simulatematch(vector<string>& debaters, unordered_map<string, int>& debaterRatings, int K){
...
int main(){
	...
	//calling the simulate match function
	simulatematch(debaters, debaterRatings, K);
